...
//query & error checks
  ...
  <div class="row justify-content-md-center m-3">
    <h2 class="m-3">Edit blog post</h2>
  </div>
  <div class="row justify-content-md-center">
    <div class="add-property-form">
      ...
      echo htmlspecialchars('../../includes/editblog.php');
        ...
        while($row = mysqli_fetch_assoc($result)){
          ...
          <div class='form-row'>
            <div class='form-group col-md-6'>
              ...
              <input type='text' name='title' class='form-control' id='' value='$row[title]'>
            </div>
            <div class='form-group col-md-6'>
              <label for='author'>Author</label>
              <input type='text' name='author' class='form-control' id='' value='$row[author]'>
            </div>
          </div>
          <div class='form-row'>
            <div class='form-group col-md-12'>
              <label for='image_link'>Image URL</label>
              <input type='text' name='image_link' class='form-control' id='' value='$row[main_img]'>
            </div>
          </div>
          <div class='form-row'>
            <div class='form-group col-md-12'>
              <label for='content_1'>Content Block 1</label>
              <textarea name='content_1' class='form-control' id='' rows='6'>$row[content_1]</textarea>
            </div>
            <div class='form-group col-md-12'>
              <label for='content_2'>Content Block 2</label>
              <textarea name='content_2' class='form-control' id='' rows='6'>$row[content_2]</textarea>
            </div>
        </div>
        <button type='submit' class='btn btn-danger btn-block'>Update Blog Post</button>
      </form>";
